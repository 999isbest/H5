(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_6989f0acd44afdd585033034")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '696c79772478139af50077fc';
_mrmcp['creative_id'] = '6989f0acd44afdd585033034';
...
_mrmcp['height'] = _mrmcp['height'] || 625;
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '无标题';
_mrmcp['build_number'] = parseInt('370');
_mrmcp['publish_time'] = 'Mon Jun 08 2026 01:12:16 GMT+0800 (China Standard Time)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['stat_host'] = 'https://6989f0acd44afdd585033034.stat.mugeda.com/stats/c.gif';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.3.70';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1780852336488", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1780852336488" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
